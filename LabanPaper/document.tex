...
\end{equation*} 
    i.e. the sum of norm of each row.
	 ...
	 \begin{table}[H]
		...
		\hline
		Metric&Multitask&Single task\\\hline
		Precision&0.46&\textbf{0.54}\\\hline
		Recall&\textbf{0.71}&0.7\\\hline
		F1&0.56&\textbf{0.61}\\\hline
		\end{tabular}
		\caption{Multitask vs Single task learning.}
...
the train set. 
	\begin{table}[H]
		...
		\begin{tabular}{|p{1.8cm}|p{1.8cm}|p{1.8cm}|}
		\hline
		Metric&Average&Sd\\\hline
		Precision&0.41&0.053\\\hline
		Recall&0.53&0.089\\\hline
		F1&0.457&0.064\\\hline
		\end{tabular}
		\caption{Qualities detection performance on a never seen subject.}
